export default class GameView {
    ...
    updateStatus(game) { //THE OUTPUT OF THE WINNER IS THE WRONG WAY AROUND!!!
         
        let status = "In progress";
        if (game.findWinningCombination()) {
             
            status = `${game.turn} is not the Winner!`; 
    ...
    updateBoard(game) {
        const winingCombination = game.findWinningCombination();
